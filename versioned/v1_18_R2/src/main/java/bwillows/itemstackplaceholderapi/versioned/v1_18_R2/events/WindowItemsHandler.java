package bwillows.itemstackplaceholderapi.versioned.v1_18_R2.events;

import bwillows.itemstackplaceholderapi.api.PlaceholderUtil;
import net.minecraft.server.v1_18_R2.ItemStack;
import net.minecraft.server.v1_18_R2.NonNullList;
import net.minecraft.server.v1_18_R2.Packet;
import net.minecraft.server.v1_18_R2.PacketPlayOutWindowItems;
