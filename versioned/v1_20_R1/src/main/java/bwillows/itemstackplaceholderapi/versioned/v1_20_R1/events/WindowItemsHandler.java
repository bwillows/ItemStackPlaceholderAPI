package bwillows.itemstackplaceholderapi.versioned.v1_20_R1.events;

import bwillows.itemstackplaceholderapi.api.PlaceholderUtil;
import net.minecraft.server.v1_20_R1.ItemStack;
import net.minecraft.server.v1_20_R1.NonNullList;
import net.minecraft.server.v1_20_R1.Packet;
import net.minecraft.server.v1_20_R1.PacketPlayOutWindowItems;
