package bwillows.itemstackplaceholderapi.versioned.v1_20_R3.events;

import bwillows.itemstackplaceholderapi.api.PlaceholderUtil;
import net.minecraft.server.v1_20_R3.ItemStack;
import net.minecraft.server.v1_20_R3.NonNullList;
import net.minecraft.server.v1_20_R3.Packet;
import net.minecraft.server.v1_20_R3.PacketPlayOutWindowItems;
